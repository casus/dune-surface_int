...
double f(const FieldVector<double,3>& x)
{
    ...
    return (4 * (pow(x[0], 4) + pow(x[1], 2) + pow(x[1], 4) + pow(x[0], 2) * (-1 + 2 * pow(x[1], 2))) * (
            ...
            pow(x[0], 2) * (
                    ...
                    (3 + 30 * pow(x[1], 2) +  \
16 * pow(x[1], 4) + 112 * pow(x[1], 6)) * pow(x[2], 2)
            ) + 2 * pow(x[0], 6) * (
                    1 - 8 * pow(x[2], 2) + 2 * pow(x[1], 2) * (
                            8 - 7 * pow(x[1], 2) - 4 * pow(x[1], 4) + 50 * pow(x[1], 6) + 224 * pow(x[1], 8) + 28 * pow(x[2], 2))) + pow(x[0], 4) * (
                    -9 * pow(x[2], 2) + 2 * pow(x[1], 2) * (
                            -3 - 8 * pow(x[2], 2) + 2 * pow(x[1], 2) * (
                                    -12 + 7 * pow(x[1], 2) + 9 * pow(x[1], 4) + 90 * pow(x[1], 6) + 112 * pow(x[1], 8) + 42 * pow(x[2],2))))))/pow(4*(pow(x[0], 2) + pow(x[1], 2))*pow((pow(x[0], 4) + pow(x[1], 2) + pow(x[1], 4) + pow(x[0], 2)*(-1 + 2*pow(x[1],2))),2)*(4*pow(x[0], 4) + pow((1 + 2*pow(x[1], 2)), 2) + pow(x[0], 2)*(-4 + 8*pow(x[1], 2))) + pow(x[2], 2), 2);
  };
